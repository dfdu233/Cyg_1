...
Page({
  ...
  data: {
    ...
    seletedIndex: 0,
    seletedSub: ["地球与行星科学学院","能源学院","环境与土木工程学院","地球物理学院","核技术与自动化工程学院","材料与化学化工学院","管理科学学院","马克思主义学院","文法学院","外国语学院","商学院","传播科学与艺术学院","体育学院","计算机与网络安全学院","地理与规划学院","生态环境学院","数理学院","机电工程学院","牛津布鲁克斯学院"]
  },
